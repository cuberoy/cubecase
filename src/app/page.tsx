        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute h-40 left-0 -top-20 hidden lg:block">
                <div className='absolute inset-x-0 bottom-0 bg-gradient-to-t via-slate-50/50 from-slate-50 h-8' />
                <img src='/stingray-1.png' className='h-full' />
              </div>
              ...
              <ul className='mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start'>
                <div className='space-y-2'>
                  <li className='flex gap-1.5 items-center text-left'>
                    ...
                    Supports modern iPhone models only
                  </li>
                  <li className='flex gap-1.5 items-center text-left'>
                    <Check className='h-5 w-5 shrink-0 text-blue-600' />
              ...
              <div className='mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5'>
                ...
                <div className='flex flex-col justify-between items-center sm:items-start'>
                  ...
                  <p>
                    <span className='font-semibold'>500,000</span> happy customers
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit'>
            <div className='relative md:max-w-xl'>
              ...
              <Phone className='w-64' imgSrc='/testimonials/0.jpg' />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
      ...
      <section className='bg-slate-100 grainy-dark py-24'>
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
          <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
            ...
            <img src='/stingray-2.png' className='h-20 order-0 lg:order-2'/>
          </div>
          ...
          <div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='text-lg leading-8'>
                <p>
                  "I usually keep my phone together with my keys in my pocket and that led to some pretty heavy scratchmarks on all of my previous phone cases. This one, besides a barely noticeable scratch on the corner,{' '}
                  <span className='p-0.5 bg-slate-800 text-white'>
      ...
      <section>
        <MaxWidthWrapper className='py-24'>
          ...
          <ul className='mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit'>
            ...
            <li className='w-fit'>
              <Check className='h-5 w-5 text-blue-600 inline mr-1.5' />
              Packaging made from biodegradable and recycled material
            </li>
            <li className='w-fit'>
              <Check className='h-5 w-5 text-blue-600 inline mr-1.5' />
          ...
          <div className='flex justify-center'>
              <Link
                ...
                <span className="text-lg">Create your case now </span><ArrowRight className='h-4 w-4 ml-1.5' />
              </Link>
            </div>
        </MaxWidthWrapper>
      </section>
