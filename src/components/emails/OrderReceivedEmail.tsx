      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img
              src={`${baseUrl}/stingray-1.png`}
              width='125'
              height='94'
              alt='delivery stingray'
              style={{ margin: 'auto' }}
            />
          ...
          <Section style={paddingY}>
            <Row>
              <Text
                ...
                Please contact us if you have any questions. You may ignore this email if you think this has been sent wrongly.
              </Text>
            </Row>
            <Row>
